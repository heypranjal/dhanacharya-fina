        ...
        >
          ...
          {[...partners, ...partners, ...partners].map((partner, index) => (
            <motion.div
              ...
              className="flex-shrink-0 bg-card rounded-2xl px-8 py-6 border border-border/50 hover:border-primary/50 hover:shadow-lg transition-all duration-300 cursor-pointer group"
            >
                ...
                <div className="w-14 h-14 rounded-xl bg-white flex items-center justify-center p-2">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.parentElement!.innerHTML = `<span class="text-xl font-heading font-bold text-primary">${partner.name.charAt(0)}</span>`;
                    }}
                  />
                </div>
