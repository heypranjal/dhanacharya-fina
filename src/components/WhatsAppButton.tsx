...
const WhatsAppButton = () => {
  const phoneNumber = "918726091695";
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-full shadow-lg cursor-pointer group"
