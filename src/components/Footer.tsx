    ...
    <footer ref={ref} className="bg-secondary text-secondary-foreground overflow-hidden">
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <motion.p
              ...
              className="text-secondary-foreground/70 leading-relaxed mb-6"
            >
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 rounded-full bg-navy-light flex items-center justify-center hover:bg-primary transition-colors group cursor-pointer"
                >
              ...
              {quickLinks.map((link, index) => (
                ...
                >
                  {link.isRoute ? (
                    <Link
                      to={link.href}
                      className="text-secondary-foreground/70 hover:text-primary transition-colors inline-flex items-center gap-2 group"
                    >
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <span className="text-secondary-foreground/70 group-hover:text-secondary-foreground transition-colors">
              ...
              >
                ...
                <div className="flex flex-col">
                  <a href="tel:+918285363331" className="text-secondary-foreground/70 hover:text-primary transition-colors">
                    +91 828-536-3331
                  </a>
                  <a href="tel:+918076542631" className="text-secondary-foreground/70 hover:text-primary transition-colors">
                    +91 807-654-2631
                  </a>
                </div>
              </motion.li>
              ...
              >
                ...
                <a href="mailto:contact@dhanacharya.com" className="text-secondary-foreground/70 hover:text-primary transition-colors">
        ...
        <motion.div
          ...
          className="border-t border-secondary-foreground/10 mt-12 pt-8 text-center"
        >
          <motion.p
