...
const ServiceCard = ({ service, index }: { service: typeof services[0]; index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-2xl p-8 card-shadow transition-all duration-300 hover:shadow-2xl border border-border/50 cursor-pointer overflow-hidden"
    >
      ...
      <div className="relative z-10">
        ...
        <motion.div
          className="flex items-center gap-2 text-primary font-medium opacity-0 group-hover:opacity-100 transition-opacity"
